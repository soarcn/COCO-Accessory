...
public class SDUtils {
     ...
     *
     * @param file
     * @param data String which you want to write a file. If size of this is greater than
     ...
     *
     * @param file
     * @param data byte array which you want to write a file. If size of this is greater than
     *             size available, it will show error.
     * @File where you want to data, will show error if it's a directory.
     */
     ...
     *
     * @param extension extension of the file, pass null if you don't want to have extension.
     * @param data      data to write
     * @throws ExternalFileWriterException if external storage is not available or free space is
     *                                     less than size of the data
     */
