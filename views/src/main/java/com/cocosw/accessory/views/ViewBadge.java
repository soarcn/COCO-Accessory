...
/**
 * Project: Accessory
 * https://github.com/jgilfelt/android-viewbadger/blob/master/src/com/readystatesoftware/viewbadger/BadgeView.java
 */
public class ViewBadge extends TextView {
    ...
    public ViewBadge(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
