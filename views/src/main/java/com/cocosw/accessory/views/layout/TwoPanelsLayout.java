...
public class TwoPanelsLayout extends ViewGroup {
    private static final String TAG = "TwoPanelsLayout";
    ...
    public TwoPanelsLayout(Context context) {
        this(context, null);
    }

    public TwoPanelsLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TwoPanelsLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        final float density = context.getResources().getDisplayMetrics().density;
        mOverhangSize = (int) (DEFAULT_OVERHANG_SIZE * density);
    ...
    interface SlidingPanelLayoutImpl {
        void invalidateChildRegion(TwoPanelsLayout parent, View child);
    }

    static class SlidingPanelLayoutImplBase implements SlidingPanelLayoutImpl {
        public void invalidateChildRegion(TwoPanelsLayout parent, View child) {
    ...
    class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            ...
            info.setClassName(TwoPanelsLayout.class.getName());
            info.setSource(host);
        ...
        public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            event.setClassName(TwoPanelsLayout.class.getName());
        }
    ...
    private class DisableLayerRunnable implements Runnable {
        ...
        @Override
        public void run() {
            if (mChildView.getParent() == TwoPanelsLayout.this) {
